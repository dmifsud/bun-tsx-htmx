                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form id="login-form" class="space-y-4 md:space-y-6" hx-post="/login" hx-target="#login-message" hx-swap="innerHTML">
                            ...
                            <div className='text-left'>
                                ...
                                <input type="password" name="password" placeholder="••••••••" required hc-invalid-target="#password-error" hc-invalid-class="invalid:border-red-500 invalid:text-red-600" hc-invalid-events="blur"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    />
                            ...
                            <button type="submit" class="disabled:opacity-15 bg-blue-700 w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                <span hc-request-loading-hide="#login-form">Sign In</span>
                                <span hc-request-loading-show="#login-form">Loading...</span>
                            </button>
